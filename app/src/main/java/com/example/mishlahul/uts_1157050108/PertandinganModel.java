...
public class PertandinganModel {
    ...
    public PertandinganModel(String nameHome, String nameAway, String scoreHom, String scoreAway, String descrription, int logoHome, int logoAway, String news) {
